...
public class Employee {
    private int id; // идентификатор, внутренний в компании
    private String firstName;
    private String lastName;
    private int age;
    private double salary; // зарплата
    private boolean gender; // пол, обычно раньше значение true- man, false - women
    ...
    public void lunch (){
        System.out.println("The employee is having lunch now");
    }
    public void sleep (){
        System.out.println("The employee is sleeping! Ups!");
