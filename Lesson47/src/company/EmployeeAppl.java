...
public class EmployeeAppl {
    public static void main(String[] args) {
        ...
        empl[0] = new Manager(100, "John", "Smith", 45, 160, 3.5,
                "Specialist",5000, 5);
        empl[1] = new SalesManager(101,"Anna", "Black", 36, 160, 1.5,
                "Specialist",25000, 0.1);
        empl[2] = new SalesManager(102,"Thomas", "White", 28, 160, 2.5,
                "Bachelor",30000, 0.1);
        empl[3] = new Worker(103, "Gans", "Bauer", 30, 80, 5.0,
                "Specialist",5);
