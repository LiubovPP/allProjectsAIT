...
public class PerfomanceTestAppl {
    // определим константы
    private static final int N_NUMBERS = 1_00000;
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Duration of addition: "+ (t2-t1) );
    ...
    private static void fillList(List<Integer> list) {
        ...
        long t2 = System.currentTimeMillis();
        System.out.println("Duration of fillig the list: "+ (t2-t1) );
