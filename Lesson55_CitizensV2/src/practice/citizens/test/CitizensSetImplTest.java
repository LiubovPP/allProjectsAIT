...
import practice.citizens.dao.CitizensListImpl;
import practice.citizens.dao.CitizensTreeSetImpl;
...
class CitizensSetImplTest {
    ...
    @BeforeEach
    void setUp() {
        citizens = new CitizensTreeSetImpl(List.of(
    ...
    void testCitizensConstructor(){
        // вызываем конструктор с двумя одинаковыми персонами (объектами)
        citizens = new CitizensListImpl(List.of(
                new Person(1, "Peter", "Jackson", now.minusYears(23)),
                new Person(1, "Peter", "Jackson", now.minusYears(23))
        ));
