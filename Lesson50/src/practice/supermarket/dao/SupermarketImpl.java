...
public class SupermarketImpl implements Supermarket{
    ...
    // или List, или ArrayList вместо Collection
    @Override
    ...
    public Product removeProduct(long barCode) {
        ...
        return removed; //вернули из метода удаленный продукт
    }
    ...
    private Iterable<Product> findByPredicate(Predicate <Product> predicate) {
        ...
        for (Product p :  products         //перебираем все продукты, находим те, которые удовлетв. условию предиката
             ) {
            if (predicate.test(p)) {
                res.add(p);
            }
