...
public class BoxWithGranates implements Iterable<Pomegranate>{
    private String name;
    private List<Pomegranate> granates;

    public BoxWithGranates(String name) {
        this.name = name;
        granates = new ArrayList<>();
    }

    public BoxWithGranates(String name, List<Pomegranate> granates) {
        this.name = name;
