package homework.granates.model;

import homework.granates.model.BoxWithGranates;
import homework.granates.model.Pomegranate;
import homework.granates.model.Seed;
...
public class PomegranateAppl {
    ...
    public static void main(String[] args) {
        List<BoxWithGranates> boxes = getRandomBoxes();

        int totalSeeds = boxes.stream()
                .mapToInt(BoxWithGranates::countSeeds)
                .sum();
...
//							.count();
    ...
    // ----Box -- Container---
    private static List<BoxWithGranates> getRandomBoxes() {
...
//		return res;
    ...
    private static BoxWithGranates getBox(int i) {
        List<Pomegranate> granates = getGranates();
        BoxWithGranates res = new BoxWithGranates("Name #" + i, granates);
        return res;
    }
